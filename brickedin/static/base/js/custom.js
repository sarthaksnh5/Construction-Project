! function(e) {
    ...
    jQuery(document).ready(function() {
        ...
        }), jQuery(".sub-menu").parent("li").addClass("has-child"), jQuery(".mega-menu").parent("li").addClass("has-child"), jQuery("<div class='fa fa-close submenu-toogle'>BrickedIN-construction-services-navigation</div>").insertAfter(".has-child > a"), jQuery(".has-child a+.submenu-toogle").on("click", function(e) {
